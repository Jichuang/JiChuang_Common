...
public class BookManage_View {
	...
	protected void createContents() {
		...
		Add.addSelectionListener(new myAddAdapter());
		...
		Button Refreshbutton = new Button(Searchgroup, SWT.NONE);
		Refreshbutton.addSelectionListener(new myRefreshAdapater());
		Refreshbutton.setBounds(586, 24, 80, 27);
		...
		SearchButton.addSelectionListener(new mySearchAdapater());
		...
		ChangeButton.addSelectionListener(new myChangeAdapater());
		...
		Delete.addSelectionListener(new myDeleteAdapater());
	...
	//按钮动作
	class myAddAdapter extends SelectionAdapter {
		public void widgetSelected(SelectionEvent e) {
			if (BookNameText.getText() != "" && AuthorNameText.getText() != ""
					&& PriceText.getText() != "") {
	...
	class myRefreshAdapater extends SelectionAdapter {
		public void widgetSelected(SelectionEvent e) {
			table.removeAll();
			for (Book book : book) {
	...
	class mySearchAdapater extends SelectionAdapter {
		public void widgetSelected(SelectionEvent e) {
	...
	class myChangeAdapater extends SelectionAdapter {
		public void widgetSelected(SelectionEvent e) {
	...
	class myDeleteAdapater extends SelectionAdapter {
		public void widgetSelected(SelectionEvent e) {
